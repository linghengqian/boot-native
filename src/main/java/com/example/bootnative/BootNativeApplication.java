...
import com.example.bootnative.enmus.MessageType;
import com.example.bootnative.entity.Messages;
import com.example.bootnative.mapper.MessagesMapper;
...
public class BootNativeApplication implements Serializable {

    public static void main(String[] args) {
        SpringApplication.run(BootNativeApplication.class, args);
    }
